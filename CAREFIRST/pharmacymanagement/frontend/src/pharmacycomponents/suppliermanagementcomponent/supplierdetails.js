...
import Sidebar from './Sidebar';
 ...
 export default class App extends Component {
   ...
   onDeleteSupplier = (supmid)=>{
    ...
    axios.delete(`http://localhost:8000/suppliers/delete/${supmid}`).then((res)=>{
  ...
  <div className='sassy'> 
    <div className='tabs'>
        <ul class="nav nav-tabs">
           ...
           <li class="nav-item">
              <a class="nav-link " aria-current="page" href="/receive">Stock Maintenance</a> 
           </li>
                            ...
                            <tbody>
                                {
                                    this.state.suppliers.map((suppliers,index) =>(
                                        ...
                                        <td>{suppliers.sid}</td>
                                                ...
                                                <a className="btn btn-warning" href={`/editsuppliers/${suppliers._id}`}>
