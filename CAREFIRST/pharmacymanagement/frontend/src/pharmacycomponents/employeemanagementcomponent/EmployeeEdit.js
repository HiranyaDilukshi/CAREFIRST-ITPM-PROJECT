    ...
    constructor(props){
        ...
        this.state={
         ...
         onEmployeeSave =(e)=>{
           ...
           axios.put(`http://localhost:8000/employee/update/${eid}`,stkdata).then((res)=>{
            if(res.data.success){
     ...
     componentDidMount(){
        ...
        axios.get(`http://localhost:8000/employee/${eid}`).then((res)=>{
            if(res.data.success){
                this.setState({
                    ...
                    Basic_salary:res.data.employee.Basic_salary
      ...
      <div >
          <div className = "container">   
              <div className = "row">
                  ...
                  <br></br> <h3 className="text-center" > EDIT EMPLOYEE</h3> <br></br>
