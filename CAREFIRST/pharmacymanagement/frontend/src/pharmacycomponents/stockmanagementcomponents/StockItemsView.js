...
<div style={{marginBottom: "20px",marginLeft:"450px",color:"#808000",fontWeight:"400",fontSize:"25px", textTransform: "uppercase"}}>  Details of the Medicine </div>
<br></br><br></br><br></br>
<div class="containerViewADM" >

    <img src={stockitemImage} style={{ height:"400px",width:"400px"}}alt="img" />
    ...
    <div class="containerViewHeadingADM ">
        ...
        {/* <div class="containerViewSubHeadADM">
                        ...
                        <div className="view"> 
                             <p style={{ fontWeight: "650"}}>     Medicine Type :-{medicineType} </p>
